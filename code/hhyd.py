...
cron: 30 */15 8-22 * * *
new Env('f花花阅读');
活动入口微信打开：http://mr1694532401668.fgrtlkg.cn/user/index.html?mid=3S5EW6YR6
下载地址：https://www.123pan.com/s/xzeSVv-IHpfv.html
公告地址：http://175.24.153.42:8881/getmsg?type=ybxkhh

使用方法：
1.活动入口,微信打开：http://mr1694532401668.fgrtlkg.cn/user/index.html?mid=3S5EW6YR6
...
class WXYD:
    ...
    def testCheck(self,a,url):
        if checkDict.get(a[4]) != None:
            ...
            for i in range(60):
                if i % 30 == 0:
                    push(f'{self.name}:花花阅读过检测', url, a[3], 'ybxkhh',self.uids,self.key)
